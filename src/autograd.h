...
private:
    ...
    friend Value scaled_dot_product_attention_causal(const Value& query, const Value& key, const Value& value, double scale);
...
Value scaled_dot_product_attention_causal(const Value& query, const Value& key, const Value& value, double scale);
